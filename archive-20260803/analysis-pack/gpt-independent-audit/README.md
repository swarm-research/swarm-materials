...
1. [`MASO两轮社会模拟深度分析-20260803.md`](reports/MASO两轮社会模拟深度分析-20260803.md)：两轮整体判断、原始交互机制、成立/不成立的主张、下一轮设计。
2. [`成本与用量审计-20260803.md`](reports/成本与用量审计-20260803.md)：2.453B 精确 token 审计、口径对齐、成本放大器和硬预算闸。
3. [`数据归档与远端状态-20260803.md`](reports/数据归档与远端状态-20260803.md)：本地原始数据位置、稳定快照与 live-cut 区别、仍在运行的远端进程边界。
...
7. `figures/`：二代执行漏斗与成本放大器的 PNG/PDF、数据值和生成脚本。
